...
p-value(유의 확률)는 간단히 귀무가설을 지지하는 확률. 귀무가설은 내가 증명하고자 하는 대립가설에 반대되는 가설이다. 즉, 유의확률이 낮을 수록 귀무가설이 거짓이 될 확률이 높아지며, 이는 내가 증명하고자 하는 대립가설이 참이 될 확률이 높아지는 것이다. 이 때, 기준은 유의 수준에 의해 결정된다. 통계에서 98%의 신뢰구간을 갖는다면 신뢰 수준은 0.98이며 유의 수준(1-신뢰 수준)은 0.02 이다. 내가 세운 가설이 참이 되게 하기 위해서는 유의 확률이 유의 수준보다 낮으면 관례적으로 대립 가설을 지지한다고 볼 수 있다.
